...
def resolve_ticket():
    ...
    '''
    return "The ticket has been passed to the Billing team"


billing_ticket_agent = LlmAgent(
    name="billing_ticket_agent",
    description = "An agent that handles the billing tickets",
    instruction = '''You are an agent that will  collect the billing_ticket details  and will use the tool 'resolve_ticket}'
